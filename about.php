...
<body class="scroll">
  ...
  <div class="content">
    <div class="container d-flex justify-content-between">
      <div class="section">
        <br></br><br></br>
        <img src="/sispak/assets/gambar/logoutu.png" alt="logoutu.png" class="logo-bio">
        <br></br><br></br>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <table style="width: 95%" align="center">
                  <tr>
                    <img src="/sispak/assets/image/7.jpg" style="width: 200px;display:block;margin:auto" alt="asep.jpg">
                    <br>
                  </tr>
                  <tr>
                                        <td style="width: 40%;"><h6>Nama</h6></td>
                                        <td style="width: 5%"><h6>:</h6></td>
                                        <td><h6>Asep nanang</h6></td>
                                    </tr>
                                    <tr>
                                        <td><h6>Tempat, Tanggal Lahir</h6></td>
                                        <td><h6>:</h6></td>
                                        <td><h6>Lae motong, 12 juni 2002</h6></td>
                                    </tr>
                                    <tr>
                                        <td><h6>Prodi</h6></td>
                                        <td><h6>:</h6></td>
                                    ...
                                    <tr>
                                        <td><h6>Alamat</h6></td>
                                        <td><h6>:</h6></td>
                                        <td><h6 style="text-align:justify">Desa Peunaga rayeuk, Meurebo, Meulaboh, Aceh Barat</h6></td>
                                    </tr>
                                    <tr>
                                        <td><h6>No. HP</h6></td>
                                        <td><h6>:</h6></td>
                                        <td><h6>082249041785</h6></td>
                                    </tr>
                                    <tr>
                                        <td><h6>Email</h6></td>
                                        <td><h6>:</h6></td>
                                        <td><h6>asep.nanang.792@gmail.com</h6></td>
                                    </tr>
                </table>
              </div>
