...
<head>
  ...
  <style>
    ...
    .banner-image {
      background-image: url('assets/gambar/km.png');
...
<body>
  ...
  <div>
    <nav class="navbar fixed-top navbar-expand-lg p-md-4">
      <div class="container">
        <a class="navbar-brand fw-bold text-white" href="#">SISPAK</a>
  ...
  <div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
    <div class="content text-center">
      <h2 class="text-white fw-bold" style="font-family: Cochin">
        WEBSITE<br  />
        SISTEM PAKAR MENDIAGNOSA PENYAKIT TANAMAN CABAI
      </h2>
      <br></br>
